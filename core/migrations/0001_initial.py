# Generated by Django 2.2.7 on 2019-11-17 19:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('close_sense', models.ForeignKey(help_text='Choose from the list close sense word', on_delete=django.db.models.deletion.CASCADE, to='core.WordTranslation')),
                ('word', models.ForeignKey(help_text='Choose from the list the word', on_delete=django.db.models.deletion.CASCADE, to='core.Word')),
            ],
        ),
    ]
