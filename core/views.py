...
def about(request, lang):
    return render(request, 'new_about.html', context={
        'lang': lang,
    })
...
def sections(request, lang):
    ...
    return render(request, 'new_sections.html', context={
        'sections': sections,
        'lang': lang,
    })
...
def subsections(request, lang, pk):
    ...
    section = SectionTranslation.objects.get(section=sec, language=lang)
    ...
    return render(request, 'new_subsections.html', context={
        'pk': pk,
...
def words(request, lang, pk):
    ...
    sub = SubsectionTranslation.objects.get(subsection=subsection, language=lang)
